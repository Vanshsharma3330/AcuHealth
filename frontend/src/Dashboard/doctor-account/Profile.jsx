    ...
    <div>
        ...
        <form>
                    ...
                    <div key={index}>
                        <div className='grid grid-cols-2 md:grid-cols-4 mb-[30px] gap-5'>
                            ...
                            <div className='flex items-center'>
                                <button onClick={e=> deleteTimeSlot(e, index)} className='bg-red-600 p-2 rounded-full text-white text-[18px] mt-8 cursor-pointer'>
                                    <AiOutlineDelete/>
                                </button>
                            </div>
                        </div>
            ...
            <div className="mb-5 flex items-center gap-3">
                {formData.photo && <figure className='w-[60px] h-[60px] rounded-full overflow-hidden border-2 border-solid border-primaryColor flex items-center justify-center'>
                    <img src={formData.photo} alt='' className='w-full object-cover h-full'/>
                  </figure>}
